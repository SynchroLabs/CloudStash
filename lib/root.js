...
module.exports = function(config, driver)
{
    ...
    var root = 
    {
        ...
        {
            driver.putObject(stripAppId(user), path, callback);
        },
        ...
        {
            driver.getObject(stripAppId(user), path, callback);
        },
        ...
        {
            driver.createDirectory(stripAppId(user), path, function(err)
            {
                callback(err);
            });
        },
        ...
        getDirectoryEntries: function(user, path, callback)
        {
            ...
            driver.traverseDirectory(stripAppId(user), path, false, onEntry, function(err, stopped)
            {
