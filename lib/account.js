...
exports.getAccount = function(account_id)
{
    if (account_id === "1234-BEEF")
    {
        return {
            account_id: lodash.padEnd(account_id, 40), // Dropbox really wants exactly 40 chars
            name: {
                given_name: "Test",
                surname: "User",
                familiar_name: "Test",
