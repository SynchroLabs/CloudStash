...
module.exports = function(_jwtSecret, config)
{
    ...
    function filesUpload(req, res, next)
    {
        ...
        // !!! There is no indication that DropBox respects/preserves Content-Type (or any other header) on upload.
        //     We have access to the client reqeust headers here, and could easily send those to driver.putObject
        //     if the driver wanted to use them.
        //
        req.log.debug("Request headers:", req.headers);
